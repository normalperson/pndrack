...
$dbo->table = 'smplate ';
$dbo->key = array('sp_id');
$dbo->sql = 'select sp_id,cus_masterid, cus_name, sp_platename, sp_platemodel, ps_code,sf_id,sp_orgid,sp_status
from smplate 
...
$dbo->colSearch = array('sp_id', 'cus_masterid', 'cus_name', 'sp_platename', 'sp_platemodel', 'ps_code', 'sf_id', 'sp_orgid');

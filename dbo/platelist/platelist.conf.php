...
$dbo->table = 'smplate';
$dbo->key = array('sp_id');
$dbo->sql = 'select sp_id,cus_masterid, cus_name, sp_platename, sp_platemodel, ps_code,sp_orgid,sp_cusid,sp_sfid,\'Checkin\' as checkin
from smplate 
...
$dbo->col = array('sp_id', 'cus_masterid', 'cus_name', 'sp_platename', 'sp_platemodel', 'ps_code', 'sp_orgid', 'sp_cusid', 'sp_sfid', 'checkin');
$dbo->colList = array('cus_masterid', 'cus_name', 'sp_platename', 'sp_platemodel', 'ps_code', 'checkin');
...
$dbo->colEdit = array('sp_cusid', 'sp_platename', 'sp_platemodel', 'ps_code', 'sp_sfid');

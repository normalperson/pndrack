...
$dbo->key = array('sp_id');
$dbo->sql = 'select sp_id,cus_masterid, cus_name, sp_platename, sp_platemodel, ps_code,sf_id,sp_orgid,cus_id
from smplate 
...
$dbo->col = array('sp_id', 'cus_masterid', 'cus_name', 'sp_platename', 'sp_platemodel', 'ps_code', 'sf_id', 'sp_orgid', 'cus_id');
...
$dbo->colEdit = array('cus_id', 'sp_platename', 'sp_platemodel', 'ps_code', 'sf_id');
$dbo->colSearch = array('sp_platename', 'sp_platemodel', 'ps_code', 'sf_id');

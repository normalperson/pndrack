...
$dbo->colList = array('cus_masterid', 'cus_name', 'sp_sfid', 'sp_platename', 'ps_code', 'sp_plateinfo', 'checkin', 'history');
...
$dbo->colEdit = array('sp_cusid', 'sp_platename', 'sp_sfid', 'sp_platemodel', 'ps_code', 'sp_plateinfo');
$dbo->colSearch = array('sp_platename', 'sp_platemodel', 'ps_code', 'sp_cusid', 'sp_sfid');
...
$dbo->cols['sp_cusid']->mandatoryEdit = 1;
...
$dbo->cols['sp_sfid']->inputTypeDefault = 'select';
$dbo->cols['sp_sfid']->mandatoryEdit = 1;
$dbo->cols['sp_sfid']->searchMode = 'exact';
$dbo->cols['sp_sfid']->capContClassDefault = array();
$dbo->cols['sp_sfid']->valContClassDefault = array();
$dbo->cols['sp_sfid']->option->default = 'select sf_id, sf_desc from smshelfsetting
order by sf_seq';
$dbo->cols['sp_sfid']->option->defaultMethod = 'sql';
...
$dbo->cols['sp_platename']->mandatoryEdit = 1;
...
$dbo->cols['cus_id']->inputTypeDefault = 'select';
$dbo->cols['cus_id']->searchMode = 'exact';
$dbo->cols['cus_id']->capContClassDefault = array();
$dbo->cols['cus_id']->valContClassDefault = array();
$dbo->cols['cus_id']->option->default = 'select cus_id, cus_name from smcustomer';
$dbo->cols['cus_id']->option->defaultMethod = 'sql';
...
$dbo->cols['ps_code']->mandatoryEdit = 1;
...
$dbo->cols['checkin'] = new DBO_COL('checkin', 'VAR_STRING', '21', '0');
$dbo->cols['checkin']->displayListModifierMethod = 'phpfunc';
$dbo->cols['checkin']->displayListModifier = 'checkin';
$dbo->cols['checkin']->inputTypeDefault = 'text';
$dbo->cols['checkin']->searchMode = 'exact';
$dbo->cols['checkin']->capContClassDefault = array();
$dbo->cols['checkin']->valContClassDefault = array();
$dbo->cols['checkin']->option->defaultMethod = 'text';
$dbo->cols['checkin']->option->searchMethod = 'text';
$dbo->cols['checkin']->option->listMethod = 'text';
$dbo->cols['checkin']->option->detailMethod = 'text';
$dbo->cols['checkin']->option->newMethod = 'text';
$dbo->cols['checkin']->option->editMethod = 'text';
$dbo->cols['sp_plateinfo'] = new DBO_COL('sp_plateinfo', 'VAR_STRING', '12000', '0');
$dbo->cols['sp_plateinfo']->inputTypeDefault = 'textarea';
$dbo->cols['sp_plateinfo']->searchMode = 'exact';
$dbo->cols['sp_plateinfo']->capContClassDefault = array();
$dbo->cols['sp_plateinfo']->valContClassDefault = array();
$dbo->cols['sp_plateinfo']->option->defaultMethod = 'text';
$dbo->cols['sp_plateinfo']->option->searchMethod = 'text';
$dbo->cols['sp_plateinfo']->option->listMethod = 'text';

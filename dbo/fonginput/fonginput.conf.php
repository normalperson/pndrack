...
$dbo->col = array('fi_id', 'fi_created', 'fi_text', 'fi_textarea', 'fi_select', 'fi_multiselect', 'fi_checkbox', 'fi_radio', 'fi_html', 'fi_integer', 'fi_date', 'fi_datetime', 'fi_time', 'fi_timestamp');
$dbo->colList = array('fi_id', 'fi_created', 'fi_text', 'fi_textarea', 'fi_select', 'fi_date');
$dbo->colListEdit = array('fi_created', 'fi_date');
...
$dbo->colNew = array('fi_text', 'fi_textarea', 'fi_html', 'fi_select', 'fi_multiselect', 'fi_radio', 'fi_checkbox', 'fi_integer', 'fi_date', 'fi_datetime', 'fi_time', 'fi_timestamp');
$dbo->colEdit = array('fi_text', 'fi_textarea', 'fi_html', 'fi_select', 'fi_multiselect', 'fi_radio', 'fi_checkbox', 'fi_integer', 'fi_date', 'fi_datetime', 'fi_time', 'fi_timestamp');
...
$dbo->cols['fi_select']->option->default = 'select fi_id, fi_text, fi_select from fonginput where fi_textarea = \'CATEGORY\'';
...
$dbo->cols['fi_multiselect']->inputTypeDefault = 'text';
...
$dbo->cols['fi_radio'] = new DBO_COL('fi_radio', 'VAR_STRING', '300', '0');
...
$dbo->cols['fi_date'] = new DBO_COL('fi_date', 'DATE', '10', '0');
$dbo->cols['fi_date']->displayDataType = 'time';
...
$dbo->cols['fi_datetime'] = new DBO_COL('fi_datetime', 'DATETIME', '19', '0');
$dbo->cols['fi_datetime']->displayDataType = 'datetime';
$dbo->cols['fi_datetime']->inputTypeDefault = 'text';
...
$dbo->cols['fi_time'] = new DBO_COL('fi_time', 'TIME', '10', '0');
$dbo->cols['fi_time']->displayDataType = 'time';
$dbo->cols['fi_time']->inputTypeDefault = 'text';
...
$dbo->cols['fi_timestamp'] = new DBO_COL('fi_timestamp', 'TIMESTAMP', '19', '0');

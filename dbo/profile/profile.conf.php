...
$dbo->colEdit = array('usr_name', 'usr_email', 'usr_langid', 'currpass', 'pass1', 'pass2');
...
$dbo->cols['usr_langid']->option->default = 'select lang_id, lang_name from fclang order by lang_name';

...
$dbo->key = array();
$dbo->sql = 'select sp_cusid, sp_platename, smb_printdate, smb_printqty, smb_remark, sp_orgid 
from smbtransaction 
join smplate on smb_spid = sp_id
join smcustomer on sp_cusid = cus_id
';
$dbo->col = array('sp_cusid', 'sp_platename', 'smb_printdate', 'smb_printqty', 'smb_remark', 'sp_orgid');
...
$dbo->colSearch = array('smb_printdate', 'smb_printqty', 'smb_remark', 'sp_platename', 'sp_cusid');

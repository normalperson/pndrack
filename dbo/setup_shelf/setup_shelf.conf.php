...
$dbo->col = array('sf_id', 'sf_sgid', 'sf_code', 'sf_desc', 'sf_totalplate', 'sf_orgid', 'sf_freeslot', 'sf_seq');
...
$dbo->cols['sf_sgid']->mandatoryNew = 1;
$dbo->cols['sf_sgid']->mandatoryEdit = 1;
...
$dbo->cols['sf_code']->mandatoryNew = 1;
$dbo->cols['sf_code']->mandatoryEdit = 1;
...
$dbo->cols['sf_desc']->mandatoryNew = 1;
$dbo->cols['sf_desc']->mandatoryEdit = 1;
...
$dbo->cols['sf_totalplate']->mandatoryNew = 1;
$dbo->cols['sf_totalplate']->mandatoryEdit = 1;
...
$dbo->cols['sf_freeslot'] = new DBO_COL('sf_freeslot', 'VAR_STRING', '60', '0');
$dbo->cols['sf_freeslot']->capContClassDefault = array();
$dbo->cols['sf_freeslot']->valContClassDefault = array();

...
$dbo->colList = array('pk_id', 'pk_description', 'pk_price', 'pk_minplate', 'pk_maxplate', 'pk_maxuser', 'pk_maxorg');
$dbo->colDetail = array('pk_description', 'pk_price', 'pk_minplate', 'pk_maxplate', 'pk_maxuser', 'pk_maxorg');
$dbo->colNew = array('pk_description', 'pk_price', 'pk_minplate', 'pk_maxplate', 'pk_maxuser', 'pk_maxorg');
$dbo->colEdit = array('pk_description', 'pk_price', 'pk_minplate', 'pk_maxplate', 'pk_maxuser', 'pk_maxorg');
$dbo->colSearch = array('pk_id', 'pk_description', 'pk_price', 'pk_minplate', 'pk_maxplate', 'pk_maxuser', 'pk_maxorg');
$dbo->colExport = array('pk_id', 'pk_description', 'pk_price', 'pk_minplate', 'pk_maxplate', 'pk_maxuser', 'pk_maxorg');
$dbo->colSort = array();
$dbo->canSearch = false;
$dbo->canNew = true;
$dbo->canEdit = true;

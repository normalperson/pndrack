...
$dbo->colNew = array('usr_userid', 'password1', 'password2', 'usr_name', 'usr_email', 'usr_status', 'userRole');
$dbo->colEdit = array('usr_userid', 'password1', 'password2', 'usr_name', 'usr_email', 'usr_status', 'userRole');
...
$dbo->whereSQL = 'usr_userid in (\'admin\', \'pndadmin\', \'user1\', \'userid\')';

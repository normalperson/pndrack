...
$dbo->colNew = array('org_code', 'org_name', 'org_parentid', 'org_address', 'org_contactno', 'org_status');
$dbo->colEdit = array('org_code', 'org_name', 'org_parentid', 'org_address', 'org_contactno', 'org_status');

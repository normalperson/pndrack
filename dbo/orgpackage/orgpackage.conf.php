...
$dbo->key = array('op_id');
$dbo->sql = 'select * from smorgpackage where op_orgid = {$toporgID}';
$dbo->col = array('op_id', 'op_orgid', 'op_packageid', 'op_created', 'op_createby', 'op_status', 'op_startdate', 'op_enddate');
$dbo->colList = array('op_id', 'op_orgid', 'op_packageid', 'op_startdate', 'op_enddate', 'op_created', 'op_createby');
$dbo->colDetail = array('op_id', 'op_orgid', 'op_packageid', 'op_created', 'op_createby', 'op_status', 'op_startdate', 'op_enddate');
$dbo->colNew = array('op_packageid', 'op_status', 'op_startdate', 'op_enddate');
$dbo->colEdit = array('op_packageid', 'op_status', 'op_startdate', 'op_enddate');

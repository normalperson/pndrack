...
$dbo->colList = array('op_id', 'op_orgid', 'op_packageid', 'months', 'op_created', 'op_createby');
$dbo->colDetail = array('op_id', 'op_orgid', 'op_packageid', 'op_created', 'op_createby', 'op_status', 'op_startdate', 'op_enddate');
$dbo->colNew = array('op_packageid', 'op_status', 'op_startdate', 'months');
$dbo->colEdit = array('op_packageid', 'op_status', 'op_startdate', 'months');

<?php /* Smarty version Smarty-3.1.13, created on 2013-12-10 20:03:04
         compiled from "C:\Zend\Apache2\fcore\inc\DBO\tpl\configFormAll.html" */ ?>
<?php /*%%SmartyHeaderCode:1254352a702f8f3b6c0-44603087%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1254352a702f8f3b6c0-44603087',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52a702f9ad1261_29175301',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52a702f9ad1261_29175301')) {function content_52a702f9ad1261_29175301($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\Zend\\Apache2\\fcore\\inc\\Smarty\\libs\\plugins\\modifier.escape.php';
?><style type="text/css">
div.dbo_container{
	color:black;
}
...
"<?php if (in_array($_smarty_tpl->tpl_vars['row']->value['grp_code'],$_smarty_tpl->tpl_vars['dbo']->value->canNewGroup)){?> checked="checked"<?php }?>/> <?php echo $_smarty_tpl->tpl_vars['row']->value['grp_title'];?>
			...
			<tr>
				<td>Can New in List</td>
				<td>
					<div>
						<label for="canlistnew_1"><input type="radio" name="canlistnew" id="canlistnew_1" value="1"<?php if ($_smarty_tpl->tpl_vars['dbo']->value->canListNew){?> checked="checked"<?php }?>> Yes </label> 
						<label for="canlistnew_0"><input type="radio" name="canlistnew" id="canlistnew_0" value="0"<?php if (!$_smarty_tpl->tpl_vars['dbo']->value->canListNew){?> checked="checked"<?php }?>> No </label> 
					</div>
				</td>
			</tr>
			<tr>
...
"<?php if (in_array($_smarty_tpl->tpl_vars['row']->value['grp_code'],$_smarty_tpl->tpl_vars['dbo']->value->canEditGroup)){?> checked="checked"<?php }?>/> <?php echo $_smarty_tpl->tpl_vars['row']->value['grp_title'];?>
			...
			<tr>
				<td>Can Edit in List</td>
				<td>
					<div>
						<label for="canlistedit_1"><input type="radio" name="canlistedit" id="canlistedit_1" value="1"<?php if ($_smarty_tpl->tpl_vars['dbo']->value->canListEdit){?> checked="checked"<?php }?>> Yes </label> 
						<label for="canlistedit_0"><input type="radio" name="canlistedit" id="canlistedit_0" value="0"<?php if (!$_smarty_tpl->tpl_vars['dbo']->value->canListEdit){?> checked="checked"<?php }?>> No </label> 
					</div>
				</td>
			</tr>
			<tr>
				...
				<td colspan="2">
					<table border="1">
						...
						<tr>
							...
							<td>Value Container Class<input type="hidden" name="valContClassDefault" id="valContClassDefault" value=""/></td>

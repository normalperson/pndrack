...
(function(root, undefined) {
	 ...
	 * Check max number
	 *
	 * get the obj and check the obj value with the max number
	 * if object value greater than max value return max value
	 */
	var checkMaxNumber = lib.checkMaxNumber = function(obj,maxval){
		var currentval = parseFloat(obj.value);		
	...
	// customize function that support format object
	var formatObj =  lib.formatObj = function(obj){
		// unformat the value
		number = unformat(obj.value);
		// reformat and assign to the value
		obj.value = formatNumber(obj.value);
	};
	// customize to return date format
	var fullRangeDate =  lib.fullRangeDate = function(imagepath){
		var dateSetting = {
			dateFormat: 'dd-mm-yy',
			showOn: "button",
	...
	*/
	lib.isNumericKey = function (e, obj, allowDecimal, allowNegative) {
